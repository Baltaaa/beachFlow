          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            ...
            <div className="p-6 md:p-8 bg-white/[0.02] rounded-lg border border-white/10 flex flex-col justify-center min-h-[220px] backdrop-blur-sm">
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 text-[10px] font-extralight text-gold hover:text-white transition-colors uppercase tracking-widest text-left font-display"
              >
              ...
              <div className="relative overflow-hidden rounded-lg border border-white/10 group h-[220px] bg-white/5">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-5">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-xs font-extralight uppercase tracking-tight flex items-center gap-1.5 hover:text-gold transition-colors font-display"
                  >
