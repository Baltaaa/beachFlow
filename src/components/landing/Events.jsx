        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            ...
            <div className="p-6 md:p-8 bg-white/[0.02] rounded-lg border border-white/10 flex flex-col justify-center min-h-[220px] backdrop-blur-sm">
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 text-[10px] font-extrabold text-gold hover:text-white transition-colors uppercase tracking-widest text-left font-display"
              >
            ...
            <div className="relative overflow-hidden rounded-lg border border-white/10 group aspect-[16/10] lg:h-[260px] bg-white/5">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-5">
                <span className="text-[8px] font-extrabold uppercase tracking-widest text-gold mb-0.5 font-display">Salón Principal</span>
                <h4 className="text-xs font-extrabold uppercase tracking-tight font-display">Nuevo Espacio Climatizado</h4>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 flex flex-col gap-4">
            ...
            <div className="relative overflow-hidden rounded-lg border border-white/10 group h-[200px] bg-white/5">
              ...
              {/* Overlay de texto integrado y minimalista */}
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-5">
                <span className="text-[8px] font-extrabold uppercase tracking-widest text-gold mb-0.5 font-display">Celebraciones</span>
                <h4 className="text-xs font-extrabold uppercase tracking-tight font-display">Cumpleaños, Fiestas de 15 y Casamientos</h4>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="relative overflow-hidden rounded-lg border border-white/10 group h-[220px] bg-white/5">
                ...
                {/* Overlay de texto integrado y minimalista */}
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-5">
                  <span className="text-[8px] font-extrabold uppercase tracking-widest text-gold mb-0.5 font-display">Experiencias</span>
                  <h4 className="text-xs font-extrabold uppercase tracking-tight font-display">Celebraciones de Día y Noche</h4>
                </div>
              </div>
              ...
              <div className="relative overflow-hidden rounded-lg border border-white/10 group h-[220px] bg-white/5">
                ...
                {/* Overlay de texto integrado y minimalista */}
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-5">
                  <span className="text-[8px] font-extrabold uppercase tracking-widest text-gold mb-0.5 font-display">Contacto Directo</span>
                  <a 
                    href="https://wa.me/542235765482" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-xs font-extrabold uppercase tracking-tight flex items-center gap-1.5 hover:text-gold transition-colors font-display"
                  >
