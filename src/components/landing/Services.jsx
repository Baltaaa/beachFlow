        ...
        <div className="relative">
          ...
          >
            {filteredImages.map((img, idx) => (
              <div 
                key={idx}
                className="w-[280px] md:w-[320px] shrink-0 snap-start group bg-white border border-hairline rounded-xl overflow-hidden flex flex-col justify-between group hover:border-gold transition-premium"
              >
