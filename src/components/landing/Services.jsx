    ...
    <section className="min-h-screen flex flex-col justify-center py-20 px-margin-mobile md:px-margin-desktop bg-prius-background border-t border-hairline" id="servicios">
      <div className="max-w-[1440px] mx-auto w-full relative z-10">
        ...
        <div className="relative">
          ...
          {/* Desvanecimiento de borde en el extremo derecho para dar efecto 'más allá' */}
          ...
          {/* Carrusel Horizontal con barra de scroll oculta */}
          <div 
            key={activeCategory}
            ref={sliderRef}
            ...
            {filteredImages.map((img, idx) => (
              ...
              >
                ...
                >
                  ...
                  {/* Botón de pantalla completa sutil */}
                  <button 
                    onClick={(e) => {
                      e.stopPropagation()
                  ...
                  <span className="absolute bottom-3 left-3 bg-neutral-950/70 backdrop-blur-md px-2.<dyad-write path="src/components/landing/Services.jsx" description="Escribiendo el archivo Services.jsx al completo para evitar truncamientos y asegurar la implementación perfecta del difuminado de borde de continuidad y la galería inmersiva con modal interactivo.">
import { useState, useRef, useEffect } from 'react'
import { ChevronLeft, ChevronRight, ArrowRight, Maximize2, X } from 'lucide-react'
...
export default function Services() {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center py-20 px-margin-mobile md:px-margin-desktop bg-prius-background border-t border-hairline" id="servicios">
      ...
      {/* MODAL FULLSCREEN INMERSIVO DE DETALLE DE IMAGEN */}
      {selectedImage && (
        <div 
        ...
        >
          ...
          >
            ...
            {/* Mitad Izquierda: Visual (3/5 de ancho en desktop) */}
            ...
            {/* Mitad Derecha: Información & Acción (2/5 de ancho en desktop) */}
