...
export default function Footer() {
  ...
  return (
    <footer className="bg-neutral-950 text-white relative overflow-hidden min-h-screen flex flex-col justify-between pt-24 pb-8">
      ...
      <div className="max-w-[1440px] mx-auto px-margin-mobile md:px-margin-desktop relative z-20 w-full flex-1 flex flex-col justify-end gap-6">
        ...
        {/* Barra de Derechos, Firma y Volver Arriba (Vidrio Esmerilado) anclada al bottom */}
        <div className="bg-neutral-950/75 backdrop-blur-md border border-white/10 rounded-2xl px-6 py-4 flex flex-col md:flex-row justify-between items-center gap-4 text-white/60 text-xs shadow-lg w-full shrink-0">
          <div>
