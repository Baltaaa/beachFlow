...
export default function Hero() {
  ...
  return (
    <section className="relative w-full bg-white flex flex-col justify-end p-2 sm:p-4 min-h-screen">
      ...
      {/* Main container constrained for 4K displays */}
      <div className="relative mx-auto flex min-h-[calc(100vh-1rem)] sm:min-h-[calc(100vh-2rem)] w-full max-w-[1920px] flex-col overflow-hidden rounded-[24px] sm:rounded-[28px]">
        ...
        {/* Central hero block */}
        <div className="mx-auto w-full px-6 sm:px-8 max-w-[1140px] relative z-10 pt-28 sm:pt-36 mb-auto">
          ...
          <div className="mt-4 grid grid-cols-1 gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
            ...
            {/* Title */}
            <div>
              <h1 className="text-[32px] sm:text-[42px] md:text-[52px] lg:text-[58px] xl:text-[64px] font-bold leading-[1.05] tracking-[-0.03em] uppercase font-display text-white select-none text-balance drop-shadow-sm">
            ...
            <div className="flex flex-col justify-end">
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
                <button 
                  ...
                  className="inline-flex h-10 w-full sm:w-auto cursor-pointer items-center justify-center rounded-full bg-gold px-7 text-[10px] sm:text-[11px] font-bold uppercase tracking-wider text-prius-black transition-all hover:bg-gold-hover shadow-md"
                >
                  VER BALNEARIO
                </button>
                <button 
                  onClick={() => scrollToSection('eventos')}
                  className="inline-flex h-10 w-full sm:w-auto cursor-pointer items-center justify-center rounded-full border border-white/40 bg-transparent px-6 text-[10px] sm:text-[11px] font-bold uppercase tracking-wider text-white transition-all hover:bg-white/10 hover:border-white/60"
                >
        ...
        <div className="mx-auto w-full px-6 sm:px-8 max-w-[1140px] relative z-10 mt-auto pb-6 sm:pb-8 shrink-0">
          <div className="transition-all duration-500 opacity-100">
            <button
              onClick={() => scrollToSection('eventos')}
              className="group mx-auto flex w-fit max-w-full items-center gap-2 rounded-full border border-white/20 bg-white/10 py-1 pl-1 pr-3 backdrop-blur-md transition-colors hover:border-white/40 hover:bg-white/20 sm:py-1.5 sm:pl-1.5 sm:pr-4 cursor-pointer"
            >
              <span className="inline-flex shrink-0 items-center gap-1 rounded-full bg-gold px-2.5 py-0.5 text-[10px] sm:text-[0.6875rem] font-bold text-prius-black sm:gap-1.5 sm:px-3 sm:py-1">
              ...
              <ArrowRight size={13} className="shrink-0 text-white/80 transition-transform duration-300 group-hover:translate-x-1" />
            </button>
          </div>
        </div>
