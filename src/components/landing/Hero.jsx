...
export default function Hero() {
  ...
  return (
    <section className="relative w-full bg-white flex flex-col justify-end p-4">
      ...
      {/* Contenedor principal con altura responsiva ajustada a 80vh en mobile */}
      <div className="relative mx-auto flex min-h-[80vh] sm:min-h-[75vh] md:min-h-[85vh] w-full max-w-[1920px] flex-col overflow-hidden rounded-[28px] justify-between py-8 px-0">
