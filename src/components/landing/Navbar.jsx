...
export default function Navbar() {
  ...
  const headerBackgroundClass = !isScrolled
    ? 'top-3 sm:top-6 md:top-8 w-full max-w-[1920px] 3xl:max-w-[2400px] px-8 sm:px-12 md:px-16'
    : 'top-3 sm:top-6 md:top-8 lg:top-0 w-full max-w-[1920px] 3xl:max-w-[2400px] lg:max-w-full px-8 sm:px-12 md:px-16 lg:px-6 lg:py-1'
    ...
    <>
      ...
      >
        <div className={`mx-auto w-full relative flex items-center justify-between gap-4 transition-all duration-500 rounded-full ${
          isScrolled 
            ? 'max-w-[1920px] 3xl:max-w-[2400px] lg:max-w-[1140px] 2xl:lg:max-w-[1600px] 3xl:lg:max-w-[1800px] px-5 sm:px-8 lg:px-8 h-[80px] sm:h-[88px] lg:h-12 2xl:lg:h-14 bg-neutral-950/80 lg:bg-neutral-950/85 backdrop-blur-md' 
            : 'max-w-[1920px] 3xl:max-w-[2400px] px-5 sm:px-8 h-[80px] sm:h-[88px] 2xl:h-[96px]'
        }`}>
          ...
          <div className="flex items-center shrink-0">
            <button 
              ...
              className="bg-transparent px-0 inline-flex items-center justify-center rounded-full transition-all duration-500 cursor-pointer"
            >
              <img 
        ...
        <div className="fixed inset-0 z-[100] bg-neutral-950/85 backdrop-blur-[4px] flex flex-col justify-between p-6 sm:p-10 animate-premium-fade lg:hidden overflow-y-auto">
          ...
          <div className="flex items-center justify-between pt-2 pb-6 border-b border-white/10 shrink-0">
            ...
            <button 
              ...
              className="w-12 h-12 rounded-full bg-white/10 hover:bg-gold hover:text-prius-black text-white border border-white/20 flex items-center justify-center transition-all duration-300 cursor-pointer shadow-lg"
