      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <aside className="w-full lg:w-80 bg-white border-r border-hairline p-6 space-y-6 shrink-0 print:hidden">
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-extrabold uppercase tracking-widest text-prius-black/40 block font-display">Buscador Inteligente</label>
          ...
          <div className="space-y-4 pt-4 border-t border-hairline">
            <h3 className="text-[10px] font-extrabold uppercase tracking-widest text-prius-black/40 font-display">Filtros de Vista</h3>
            
            <div className="space-y-3">
              <div>
                <label className="text-[9px] font-extrabold uppercase tracking-wider text-prius-black/60 block mb-1 font-display">Tipo de Unidad</label>
                <select 
                  value={typeFilter} 
              ...
              <div>
                <label className="text-[9px] font-extrabold uppercase tracking-wider text-prius-black/60 block mb-1 font-display">Estado de Reserva</label>
                <select 
                  value={statusFilter} 
              ...
              <div>
                <label className="text-[9px] font-extrabold uppercase tracking-wider text-prius-black/60 block mb-1 font-display">Estado de Pago</label>
                <select 
                  value={paymentFilter} 
          ...
          <div className="space-y-3 pt-4 border-t border-hairline">
            <h3 className="text-[10px] font-extrabold uppercase tracking-widest text-prius-black/40 font-display">Ocupación Actual</h3>
            <div className="grid grid-cols-2 gap-2">
              <div className="p-3 bg-prius-black text-white rounded-sm">
                <p className="text-xl font-normal">{stats.carpasOcupadas}</p>
                <p className="text-[8px] font-extrabold uppercase tracking-widest opacity-60 font-display">Carpas Ocupadas</p>
              </div>
              <div className="p-3 bg-white border border-hairline rounded-sm">
                <p className="text-xl font-normal">{stats.carpasLibres}</p>
                <p className="text-[8px] font-extrabold uppercase tracking-widest text-prius-black/40 font-display">Carpas Libres</p>
              </div>
              <div className="p-3 bg-gold text-prius-black rounded-sm">
                <p className="text-xl font-normal">{stats.sombrillasOcupadas}</p>
                <p className="text-[8px] font-extrabold uppercase tracking-widest opacity-80 font-display">Sombrillas Ocupadas</p>
              </div>
              <div className="p-3 bg-white border border-hairline rounded-sm">
                <p className="text-xl font-normal">{stats.sombrillasLibres}</p>
                <p className="text-[8px] font-extrabold uppercase tracking-widest text-prius-black/40 font-display">Sombrillas Libres</p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-hairline space-y-3">
            <h3 className="text-[10px] font-extrabold uppercase tracking-widest text-prius-black/40 flex items-center justify-between font-display">
              <span>Tareas del Día</span>
              <span className="bg-gold/20 text-prius-black px-1.5 py-0.5 rounded-full text-[8px] font-extrabold">
          ...
          <div className="pt-4 border-t border-hairline">
            <h3 className="text-[10px] font-extrabold uppercase tracking-widest text-prius-black/40 mb-3 font-display">Leyenda</h3>
            <div className="grid grid-cols-2 gap-2 text-[10px] font-display font-extrabold">
          ...
          <div className="flex items-center justify-between mb-6 bg-white border border-hairline p-3 rounded-sm print:hidden">
            <div className="flex items-center gap-2">
              <button 
                ...
                className={`px-4 py-2 rounded-sm font-extrabold text-[10px] uppercase tracking-widest transition-all flex items-center gap-2 font-display ${viewMode === "map" ? 'bg-gold text-prius-black' : 'hover:bg-prius-background'}`}
              >
              ...
              <button 
                ...
                className={`px-4 py-2 rounded-sm font-extrabold text-[10px] uppercase tracking-widest transition-all flex items-center gap-2 font-display ${viewMode === "list" ? 'bg-gold text-prius-black' : 'hover:bg-prius-background'}`}
              >
            ...
            {searchTerm && (
              <div className="text-[10px] font-extrabold uppercase tracking-wider text-gold bg-prius-black px-3 py-1.5 rounded-sm flex items-center gap-2 font-display">
          ...
          {viewMode === "map" ? (
            ...
            <div className="bg-white border border-hairline p-4 md:p-8 rounded-sm shadow-sm max-w-full overflow-auto print:border-0 print:shadow-none print:p-0 print:m-0 print:max-w-none print:overflow-visible">
              <div className="print-container mx-auto" style={{ maxWidth: "950px" }}>
                <div className="flex justify-center mb-6">
                  <div className="flex text-[10px] font-extrabold uppercase tracking-widest font-display">
                  ...
                  <div className="flex gap-12">
                    ...
                    <div className="flex flex-col gap-1 relative">
                      ...
                      <div className="absolute top-0 left-0 w-[280px] h-[62px] bg-sky-100 border-2 border-sky-300 rounded-sm flex flex-col items-center justify-center overflow-hidden z-20 shadow-inner">
                        ...
                        <span className="text-[9px] font-extrabold uppercase tracking-[0.2em] text-sky-800 z-10 font-display">Piscina Climatizada</span>
                        <span className="text-[7px] font-extrabold uppercase tracking-wider text-sky-600/80 z-10 font-display">Exclusivo Prius</span>
                      </div>
                ...
                <div className="mt-12 flex justify-center">
                  <div className="w-full max-w-[600px] bg-prius-black py-3 text-center text-white font-extrabold text-xs tracking-[0.3em] uppercase font-display">
                    Mar Argentino
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white border border-hairline rounded-sm shadow-sm overflow-hidden">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-prius-black text-white text-[10px] font-extrabold uppercase tracking-widest font-display">
